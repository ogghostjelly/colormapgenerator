...
/**
 * Modified version of LookingPosArgument to support FabricClientCommandSource
 */
public class FabricClientLookingPosArgument implements FabricClientPosArgument {
    public static final char CARET = '^';
    private final double x;
    private final double y;
    private final double z;

    public FabricClientLookingPosArgument(double x, double y, double z) {
        this.x = x;
        this.y = y;
        this.z = z;
    }
    ...
    public Vec3d toAbsolutePos(FabricClientCommandSource source) {
        ...
        Vec3d vec3d = entity == null ? source.getPosition() : EntityAnchorArgumentType.EntityAnchor.FEET.positionAt(entity);
    ...
    public static FabricClientLookingPosArgument parse(StringReader reader) throws CommandSyntaxException {
        ...
        if (reader.canRead() && reader.peek() == ' ') {
            ...
            if (reader.canRead() && reader.peek() == ' ') {
                ...
                return new FabricClientLookingPosArgument(d, e, f);
            } else {
                reader.setCursor(i);
    ...
    public boolean equals(Object o) {
        if (this == o) {
            ...
            return o instanceof FabricClientLookingPosArgument lookingPosArgument && this.x == lookingPosArgument.x && this.y == lookingPosArgument.y && this.z == lookingPosArgument.z;
        }
    }
