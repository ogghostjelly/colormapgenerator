...
/**
 * Modified version of BlockPosArgumentType to support FabricClientCommandSource
 */
public class FabricClientBlockPosArgumentType implements ArgumentType<FabricClientPosArgument> {
    ...
    public static FabricClientBlockPosArgumentType blockPos() {
        return new FabricClientBlockPosArgumentType();
    }
    ...
    public static BlockPos getBlockPos(CommandContext<FabricClientCommandSource> context, String name) {
        return context.getArgument(name, FabricClientPosArgument.class).toAbsoluteBlockPos(context.getSource());
    }
    ...
    public FabricClientPosArgument parse(StringReader stringReader) throws CommandSyntaxException {
        return (FabricClientPosArgument)(stringReader.canRead() && stringReader.peek() == '^' ? FabricClientLookingPosArgument.parse(stringReader) : FabricClientDefaultPosArgument.parse(stringReader));
    }
